...
const C = @import("game/class.zig").Class;
const class = @import("game/class.zig").classes;
const P = @import("game/player.zig").Player;
const PL = @import("game/map.zig").Place;
const M = @import("game/monster.zig").Monster;
const W = @import("game/world.zig").World;
